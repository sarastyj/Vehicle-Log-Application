...
<thead>
                        <tr>
                            <td align="center"colspan="15"><h3><b>Vehicle Report - ID# <?php echo $user_id?></b></h3></td>
                        </tr>
                    </thead>
                    <tr>
                        <th>Make</th>
                ...
                <thead>
                        <tr>
                            <td align="center"colspan="15"><h3><b>Maintenance Records</b></h3>
                            </td>
                        </tr>
                        <tr>
                            <td align="center"colspan="15"><h4><b>Total Repair Costs: $<?php echo number_format($totalRepairCost,2)?></b></h4></td>
                        </tr>
                        <?php
                        if(count($vehicles)=== 0){
                         ?>
                       <div class="alert alert-warning alert-dismissible">
                           ...
                           <strong>Info!</strong> No vehicle records found under this profile. Please select a <b><a href="vehicles.php">vehicle</a></b> to add a maintenace record.
                       </div>
                       <?php
                         }
                        ?>
                    ...
                    <tr>
                        ...
                        <th>Date Created</th>
                        <th>Date Modified</th>
                        <th><form method="POST" action="maintenance_add_form.php">
    ...
    // Formatting dates from database
        ...
        ?>
                ...
                <thead>
                        <tr>
                            <td align="center"colspan="15"><h3><b>Fuel</b></h3>
                            </td>
                            <tr>
                            <td align="center"colspan="15"><h4><b>Total Fuel Cost: $<?php echo number_format($totalFuelCost,2)?></b></h4></td>
                        </tr>
                            <tr>
                            <td align="center"colspan="15"><h4><b>Average Fuel Cost: $<?php echo number_format($avgFuelCost,2)?></b></h4></td>
                        </tr>
                        <tr>
                            <td align="center"colspan="15"><h4><b>Average Miles Per Gallon: <?php echo $mpg?> gal.</b></h4></td>
                        </tr>
                        </tr>
                    </thead>
                    <tr>
                        ...
                        <th><form method="POST" action="fuel_add_form.php">
